...
function Activities(props){
  return(    <Grid item xs={12} sm={6} md={4}>
    ...
    <CardActionArea component={aLink} to="/changeActivities" state={{ activitiesId: props.activitiesId,
    ...
    activitiesPhone:props.activitiesPhone,activitiesHours:props.activitiesHours,planId:props.planId}}>
        <CardMedia
          component="img"
          height="200"
...
export default function ChangeCardActivities(props) {
  ...
  return (
    ...
    justify="center"
  >
    {activitiesData.map((activities) => <Activities key={activities.activitiesId} activitiesId = {activities.activitiesId} activitiesName= {activities.activitiesName} activitiesType={activities.activitiesType} 
    ...
    activitiesPhone={activities.activitiesPhone} planId={props.planId}
    />)}
    </Grid>
