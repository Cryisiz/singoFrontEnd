...
function Restaurant(props){
  return(    <Grid item xs={12} sm={6} md={4}>
    ...
    <CardActionArea component={aLink} to="/changeRestaurant" state={{ restaurantId: props.restaurantId,
...
export default function ChangeCardRestaurant(props) {
  ...
  >
    ...
    restaurantPhone={restaurant.restaurantPhone} planId = {props.planId}
    />)}
    </Grid>
